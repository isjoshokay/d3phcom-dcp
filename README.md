...
This server collects the data that would be processed and stored in MongoDB. A separate server handles data fetching and retrieving for end user clients.
